      ...
      virtualNetworkLinks: [
        {
          ...
          virtualNetworkResourceId: network!.outputs.subnetPrivateEndpointsResourceId
        }
      ]
    }
  }
...
output AZURE_OPENAI_EMBEDDING_ENDPOINT string = aiFoundryAiServices.outputs.aiProjectInfo.apiEndpoint
