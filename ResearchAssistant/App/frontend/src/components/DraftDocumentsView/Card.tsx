...
export const RegenerateIcon = createSvgIcon({
  svg: ({ classes }) => (
...
export const SystemErrMessage = 'I am sorry, I don’t have this information in the knowledge repository. Please ask another question.'
    ...
    <FluentCard className={styles.card} {...props}>
      ...
      <div className={mergeClasses(styles.flex, styles.cardContent)}>
        <div className={styles.cardParagraph}>
          <p
            data-testid="editable_container"
