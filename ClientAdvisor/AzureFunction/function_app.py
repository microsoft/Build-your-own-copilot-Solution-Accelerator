...
async def stream_openai_text(req: Request) -> StreamingResponse:
    ...
    **If the client name in the question does not match the selected client's name**, always return: "Please ask questions only about the selected client." Do not provide any other information.     Always consider to give selected client full name only in response and do not use other example names also consider my client means currently selected client.
