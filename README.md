...
7. Test the app locally with the sample question with any selected client: Show latest asset value by asset type?. For more sample questions you can test in the application, see [Sample Questions](./docs/SampleQuestions.md).
